...
/*This page is very similar to buyer, except it orders available instruments by increasing price.*/

$username = $_SESSION['username'];
$_SESSION['sort'] = "low_to_hi";
...
$sql = "SELECT * FROM instrument WHERE status = 'available' AND owner_username != '$username' ORDER BY price";
				...
				<div class="col s6 md3">
					<div class="card z-depth-0">
						...
						<div class="card-action center">
							<form class="white" action="lowtohi.php" method="POST">
