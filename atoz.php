...
/*This page is very similar to buyer, except it orders available instruments alphabetically.*/
...
$sql = "SELECT * FROM instrument WHERE status = 'available' AND owner_username != '$username' ORDER BY name";
				...
				<div class="col s6 md3">
					<div class="card z-depth-0">
						...
						<div class="card-action center">
							<form class="white" action="atoz.php" method="POST">
